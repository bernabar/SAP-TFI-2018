...
<div id="title_bar">
	...
	<div id="new_button">
		...
		'<button class="btn pull-left btn-primary">'.$this->lang->line($controller_name.'_new').' (alt+n)</button>',
		...
		"<button class='btn pull-left'>".$this->lang->line('common_import_excel')."</button>",
...
/*
	...
	<div style="float:left;vertical-align:text-top;"><?php echo($this->lang->line('common_search_option')); ?></div>
...
<div id="table_action_header">
	<ul>
		<li class="float_left"><button class="btn btn-warning"><?php echo anchor("$controller_name/delete",$this->lang->line("common_delete"),array('id'=>'delete', 'class'=>'alt_del')); ?>(alt+del)</button></li>
		<li class="float_left"><button class="btn btn-success"><?php echo anchor("$controller_name/bulk_edit/width:$form_width",$this->lang->line("items_bulk_edit"), array('id'=>'bulk_edit', 'class'=>'alt_q', 'title'=>$this->lang->line('items_edit_multiple_items'))); ?></button></li>
		<li class="float_left"><button class="btn btn-primary"><?php echo anchor("$controller_name/generate_barcodes",$this->lang->line("items_generate_barcodes"),array('id'=>'generate_barcodes', 'class'=>'alt_w', 'target' =>'_blank','title'=>$this->lang->line('items_generate_barcodes'))); ?></button></li>
        <div class="pull-left">
            <?php echo form_open("$controller_name/refresh",array('id'=>'items_filter_form')); ?>            
       	    <?php echo form_label($this->lang->line('items_low_inventory_items'), 'low_inventory',array('class'=>'pull-left'));?>
		...
		<input type="text" name ='search' id='search' placeholder="<?php echo $this->lang->line("common_search"); ?>"/>
		</form>
		</li>
	</ul>
</div>
