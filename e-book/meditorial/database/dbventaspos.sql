...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-05-2015 a las 01:11:13
...
('address', 'Chiclayo - Perú', 0),
('company', 'MarketPlace Import S.A.C', 0),
('currency_symbol', 'S/..', 0),
('default_tax_1_name', 'IGV', 0),
('default_tax_1_rate', '18', 0),
('default_tax_2_name', 'Percepción IGV', 0),
('default_tax_2_rate', '2', 0),
...
(11, 'BCA', NULL, 0, 0, 1, 0),
(12, 'dbventasposu.com', NULL, 1, 0, 0, 0);
...
('Amoxixilina 200ml', 'Medicamentos', 10, '0946386525721', '', 0.50, 1.00, 37, 5, '', 2, 0, 0, 0, 0),
('Coca Cola 300ml', 'Bebidas', 4, '1111', '', 2.00, 3.00, 100, 20, 'Rak 1', 3, 0, 0, 0, 0),
('Marcador para Pizarra', 'Útiles Escolares', 10, 'R21921921', '', 3.00, 5.00, 9, 100, 'Chiclayo', 4, 0, 1, 0, 0),
...
(1, 'Juan carlos', 'Arcila Díaz', '979026684', 'jcarlos.ad7@gmail.com', 'Address 1', '', '', '', '', '', ''),
(2, 'Darwin', 'Tok', '0810000000', 'darwin@tok.com', '', '', '', '', '', '', ''),
(3, 'Tyas', 'Ahmad', '085090000', 'tyas@ahmad.com', '', '', '', '', '', '', ''),
(4, 'Luis', 'Arcila Díaz', '', 'luis.pad7@gmail.com', 'José Gálvez 1368', '', 'Chiclayo', 'Lambayeque', '', 'Perú', ''),
...
('d5f6097b3c2a312642d55b0fc152ea59', '0.0.0.0', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36', 1431469945, '');
...
(4, 'Grupo Arcila S.A.C.', NULL, 0, 0),
(10, 'Inversiones Santa Catalina S.A C ', NULL, 0, 0);
